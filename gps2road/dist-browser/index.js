...
export async function gps2road({ point }) {
    ...
    let foundroad = null;
    if (shortest_interstate && shortest_interstate.dist < MAXROADWIDTH_FEET)
        foundroad = shortest_interstate.road;
    else if (shortest_state && shortest_state.dist < MAXROADWIDTH_FEET)
        foundroad = shortest_state.road;
